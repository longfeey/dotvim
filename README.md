...
1.  execute the script ./install.sh,it will backup old vim configuration and the initiate the new vim plugin.

Please config the customize vim enviroment to .vimrc
